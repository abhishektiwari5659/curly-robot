...
class Browser(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.back_action = QtWidgets.QAction(QtGui.QIcon("backward.png"), "", self)
        self.forward_action = QtWidgets.QAction(QtGui.QIcon("forward.png"), "", self)
        self.refresh_action = QtWidgets.QAction(QtGui.QIcon("refresh.png"), "", self)
